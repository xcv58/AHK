...
#Include %A_ScriptDir%
;-----------------在浏览器里的快捷键-------------------
;GroupAdd, Browsers , ahk_class Chrome_WidgetWin_0;old Chromium/Chrome
;GroupAdd, Browsers , ahk_class Chrome_WidgetWin_1;new Chromium/Chrome
;GroupAdd, Browsers , ahk_class ahk_class IEFrame;IE
;GroupAdd, Browsers , ahk_class ahk_class MozillaWindowClass;Firefox
;GroupAdd, Browsers , ahk_class ahk_class ahk_class AcrobatSDIWindow;AdobePlugins
;#If WinActive(ahk_group Browsers)
#If WinActive("ahk_class Chrome_WidgetWin_0") or WinActive("ahk_class Chrome_WidgetWin_1") or WinActive("ahk_class IEFrame") or WinActive("ahk_class MozillaWindowClass") or WinActive("ahk_class AcrobatSDIWindow")
